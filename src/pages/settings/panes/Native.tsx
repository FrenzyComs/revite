    ...
    return (
        <div style={{ marginTop: "10px" }}>
            ...
            <Checkbox
                ...
                description="Launch Frenzy when you log into your computer."
            />
            ...
            <Checkbox
                ...
                description="Instead of closing, Frenzy will hide in your tray."
            />
            <Checkbox
                ...
                description="Rep Frenzy on your Discord status."
            />
            {/* <Checkbox
            ...
            <Checkbox
                ...
                description="Let Frenzy use its own window frame."
            />
